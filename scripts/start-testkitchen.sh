...
./valheim_server.x86_64 -name "Lunch Crew Alumni (Testkitchen)" -password "password" -nographics -batchmode -port 2456 -world "testkitchen" -savedir "/opt/valheim-server/config" -public 1
